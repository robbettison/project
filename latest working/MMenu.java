...
public class MMenu extends Application{
  ...
  public static final int count = 20;
	...
	private void press(ActionEvent event) {
	  ...
	  switch(text){
	  	...
	  	case "Instructions":
	  		...
	  		try {
	  			instruct.root.getChildren().add(instructionLabel());
	  		} catch (IOException e) {
	  			System.out.println("OH no!");
	  		}
	  		instruct.instructionShow();
	...
	public Button createButton(String name){
  	...
  	private Group animate(Group root, Scene scene) {
	...
	public void start (Stage stage){
	  ...
	  Label gameName = new Label("BUG BITS");
	    ...
	    //root.getChildren().add(animate(scene));
	    animate(root,scene);
