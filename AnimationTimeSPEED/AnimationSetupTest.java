            ...
            /*Timeline tl = new Timeline(
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                ...
                public void handle(ActionEvent t) {
                  ...
                  caterpillar.getChildren().add(slides[0]);
              ...
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                ...
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[1]);
              ...
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                ...
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[3]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[4]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[5]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[6]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[7]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[8]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[9]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[10]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[11]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[12]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[13]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[14]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[15]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[16]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[17]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[18]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[19]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[20]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[21]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
                public void handle(ActionEvent t) {
                  //caterpillar.getChildren().remove(0);
                  caterpillar.getChildren().add(slides[22]);
                }
              }),
              new KeyFrame(Duration.millis(10000), new EventHandler<ActionEvent>(){
                @Override
